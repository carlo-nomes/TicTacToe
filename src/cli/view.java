...
public class view {
    ...
    private static final char AI_PLAYER_2 = 'O';
    ...
    public static void main(String[] args) {
        ...
        while (cont) {
            try {
                ...
                ai1 = new Minimax(AI_PLAYER_1, AI_PLAYER_1 == playerX ? playerO : playerX, 3);
                ai2 = new Minimax(AI_PLAYER_1, AI_PLAYER_2 == playerX ? playerO : playerX, 5);
